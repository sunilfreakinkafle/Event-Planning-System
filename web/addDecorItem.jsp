<%-- 
    Document   : addDecorItem
    Created on : Mar 22, 2018, 10:30:50 AM
    Author     : kafle
--%>
    ...
    <body>
        ...
        %>
         ...
         <form method="POST">
           ...
           <input type="text" name="decorItem"/><br/></br>
           
           <label>Decor-Quantity:</label>
           <input type="text" name="decorQuantity"/></br><br/>
           
           <label>Decor-Price:</label>
            <input type="text" name="decorPrice"/><br/><br/>
